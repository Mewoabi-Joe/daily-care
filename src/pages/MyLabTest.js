        ...
        {variableTests.length < 2 &&
          ...
          !filterLoading && (
            <div
              ...
              style={{ position: "fixed", bottom: 20, backgroundColor: "#aaa" }}
            >
              <p className="p-3">
                After booking a lab test, you can call, email or message us if
                you're not clear on the test requirements. You'll send to us
                your home location, the date and time when your samples would be
                ready.{" "}
              </p>
              <a
                aria-label="Chat on WhatsApp"
                href="https://wa.me/+237670240005"
              >
                {" "}
