      ...
      <div className="container">
        <div className="d-lg-flex justify-content-between align-items-center text-center py-0 py-lg-5">
          <div className="text-center text-lg-start h4">
            <p>
              We carry out tests <span className="text-info">24</span> hours a
              day, <span className="text-info">365</span> days a year.
            </p>
            <p className="">
              Ensuring you get accurate results as fast possible is our priority
              at <span className=" text-info fw-bolder">Spectrum Lab</span>
            </p>
          ...
          {/* <img
            src={firstIllus}
            alt="first illustration"
            className="d-inline-block d-lg-none img-fluid w-75"
          /> */}
        </div>
      </div>
    </section>
