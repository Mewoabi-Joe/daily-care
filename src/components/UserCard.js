...
const UserCard = ({ firstName, lastName, email, phoneNo, dateOfBirth, index }) => {
	...
	return (
		<div className="card mb-3 w-100 border-0 user-card">
			<div className="row g-0 justify-content-center">
				<div
					style={{ width: 90, height: 90, verticalAlign: "middle", backgroundColor: getColorByPosition() }}
				...
				<div className="col-8">
					<div className="card-body p-0 ps-3">
						...
						<p className="card-text ">
							<small className="text-muted ">Telephone</small> <small>{phoneNo}</small>
						</p>
						<p className="card-text mb-2 ">
							<small className="text-muted ">Email</small> <small>{email}</small>
						</p>
					</div>
				</div>
			</div>
