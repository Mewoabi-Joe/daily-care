  ...
  return tests.length ? (
    ...
    >
      <div className="container">
        ...
        <div>
          <div className=" mb-2">
            We have a wide range of lab test, pick those you want to book
            appointments for
          </div>
          <Link
            className="text-end me-3 d-block text-decoration-none"
            style={{ color: "#0AA2C0" }}
            to="/lab_tests"
          >
            SEE ALL
        ...
        >
          <div className="carousel-inner ">
            {generateCarouselItemsForMobileScreens(tests)}
          </div>
          <button
        ...
        <div
          id="carouselMedium"
          className="carousel slide  d-none d-sm-block d-lg-none"
          data-bs-ride="carousel"
        >
          <div className="carousel-inner">
            {generateCarouselItemsForMediumScreens(tests)}
          </div>
          <button
            className="carousel-control-prev"
            type="button"
        ...
        >
          <div className="carousel-inner">
            {generateCarouselItemsForLargeScreens(tests)}
          </div>
          <button
            className="carousel-control-prev"
            type="button"
            data-bs-target="#carouselLarge"
            data-bs-slide="prev"
          >
            <span
              className="carousel-control-prev-icon"
